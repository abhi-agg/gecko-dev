 ...
 *  - no. of columns of Input matrix A (`colsA`) = no. of rows of Input matrix B (`rowsB`) = `width`
 ...
 * function (`int8_multiply_and_add_bias`).
 *
 * Please note that this interface might have architecture specific implementation.
 *
 * @param[in]   inputMatrixB        An array representing the Input matrix B in row-major format.
 ...
 * @param[in]   rowsB               No. of rows of Input matrix B. It should be a positive integer and a multiple of 64.
 * @param[in]   colsB               No. of columns of Input matrix B. It should be a positive integer and a multiple of 8.
 ...
 * Please note that this interface might have architecture specific implementation.
 *
 * @param[in]   inputMatrixBTransposed An array representing transposed version of Input matrix B.
 ...
 * format on the disk.
 *
 * @param[in]   inputMatrixBQuantizedTransposed  An array representing the quantized and transposed
 *                                               version of Input matrix B. It is in column-major format.
 *                                               Size of the array = `rowsB` * `colsB`.
 *                                               Shape of the matrix: (`colsB`, `rowsB`)
 * @param[in]   rowsB                            No. of rows of Input matrix B. Should be a positive integer and a multiple of 64
 * @param[in]   colsB                            No. of columns of Input matrix B. Should be a positive integer and a multiple of 8
 * @param[out]  outputMatrixB                    An array representing the prepared B matrix.
 *                                               Size of the array = `rowsB` * `colsB`.
 *
 ...
 * Please note that this interface might have architecture specific implementation.
 *
 * @param[in]   inputMatrixA   An array representing the Input matrix A in row-major format.
 *                             Size of the array = `rowsA` * `colsA`.
 *                             Shape of the matrix: (`rowsA`, `colsA`)
 * @param[in]   scale          The scaling factor (for quantization)
 * @param[in]   zeroPoint      The zero point (for quantization)
 * @param[in]   rowsA          No. of rows of Input matrix A. It should be a positive integer.
 * @param[in]   colsA          No. of columns of Input matrix A. It should be a positive integer and a multiple of 64.
 ...
 *
 * It uses the prepared B (which must be obtained by using any of the int8_prepare_b* functions) and
 * a bias input to prepare the final bias.
 *
 * The final bias can be used as an input to matrix multiply function (`int8_multiply_and_add_bias`).
 *
 * @param[in]   inputMatrixBPrepared An array representing the prepared B matrix.
 *                                   Size of the array = `rowsB` * `colsB`.
 ...
 * @param[in]   rowsB                No. of rows of Input matrix B (unquantized & non-transposed).
 *                                   It should be a positive integer and a multiple of 64.
 * @param[in]   colsB                No. of columns of Input matrix B (unquantized & non-transposed)
 *                                   It should be a positive integer and a multiple of 8.
 * @param[in]   inputBias            An array representing the input bias. Size of array = `colsB`
 ...
 * obtained by using `int8_prepare_A`, one of the `int8_prepare_b*` and `int8_prepare_bias`
 * functions respectively.
 *
 * Please note that this interface might have architecture specific implementation.
 *
 * @param[in]   inputMatrixAPrepared   An array representing the prepared A matrix.
 *                                     This must be obtained by using `int8_prepare_A` function.
 *                                     Size of the array = `rowsA` * `width`.
 * @param[in]   scaleA                 The scaling factor (for quantization) of A
 * @param[in]   zeroPointA             The zero point (for quantization) of A
 * @param[in]   inputMatrixBPrepared   An array representing the prepared B matrix.
 *                                     This must be obtained by using one of `int8_prepare_b*`
 *                                     functions. Size of the array = `width` * `colsB`.
 * @param[in]   scaleB                 The scaling factor (for quantization) of B
 * @param[in]   zeroPointB             The zero point (for quantization) of B
 * @param[in]   inputBiasPrepared      An array representing the prepared bias.
 *                                     This must be obtained by using `int8_prepare_bias` function.
 *                                     Size of the array = `colsB`
 * @param[in]   unquantMultiplier      A value that will be multiplied to the final unquantization
 *                                     factor that is prepared from `scaleA` and `scaleB`.
 * @param[in]   rowsA                  No. of rows of Input matrix A. It should be a positive integer.
 * @param[in]   width                  No. of columns of Input matrix A (same as no. of columns of
 *                                     Input matrix B). It should be a positive integer and a multiple of 64.
 * @param[in]   colsB                  No. of columns of Input matrix B. Should be a multiple of 8.
 ...
 *
 * @param[in]   inputMatrixBPrepared  An array representing the prepared B matrix.
 *                                    This must be obtained by using one of the `int8_prepare_b*`
 *                                    functions Size of the array = `rowsB` * `colsB`.
 * @param[in]   rowsB                 No. of rows of Input matrix B. It should be a positive integer and a multiple of 64.
 * @param[in]   colsB                 No. of columns of Input matrix B. It should be a positive integer and a multiple of 8.
 * @param[in]   colIndexList          An array of column indices to be selected from prepared B.
 *                                    All indices of the array should be valid. i.e.
 *                                    0 <= colIndexList[N] < colsB   where N = 0, 1, 2 .... (`sizeColIndexList`-1)
 * @param[in]   sizeColIndexList      Size of the `colIndexList` array. It should be a positive integer and a multiple of 8.
 * @param[out]  output                An array representing the selected columns of prepared B.
 *                                    Size of the array = `rowsB` * `sizeColIndexList`.
 *
